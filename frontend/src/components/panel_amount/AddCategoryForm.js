    ...
    return(
        <div className="form-add-category">
            ...
            <div className="name-category">
                <InputNormal value={categoryName} onchange={handleCategoryName} {...dataCategory.categoryName}/>
                {errors.categoryName && <div className="error-add-category">{messages.categoryName}</div>}
            </div>
