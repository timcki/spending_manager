	...
	return (
		<>
			...
			<FormTransactions
				...
				/* 				p_date={
					new Date(Object.keys(location.state.transaction_date)[0])
				} */
				p_selectCategory={location.state.category_id.value}
				p_selectType={transaction_types[location.state.transation_type]}
